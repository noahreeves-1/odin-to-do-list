...
class Task {
    constructor(description, dueDate, priority, complete = false, id = Math.random()) {
        ...
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dueDate), 'MM-dd-yyyy');
...
newTaskContainerForm.addEventListener("submit", (e) => {
    ...
    for (let i = 0; i < projectsArray.length; i++) {
        if (selectedProjectID === projectsArray[i].id.toString()) {
            ...
            const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "MM/dd/yyyy");
            const priority = "Low";
...
editTaskButton.addEventListener('click', (e) => {
    ...
    if (currentTask.id.toString() === selectedTaskId.toString()) {
        ...
        editTaskDueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(Date.parse(currentTask.dueDate), 'yyyy-MM-dd');
...
saveTaskEditsBtn.addEventListener('click', (e) => {
    ...
    // save task due date
    currentTask.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(Date.parse(editTaskDueDate.value), 'MM-dd-yyyy');
    // save task priority
